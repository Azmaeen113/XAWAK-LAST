...
const Navigation: React.FC = () => {
  ...
  // Effect to handle the navbar logo appearance after hero logo animation
  useEffect(() => {
    const timer = setTimeout(() => {
      setShowNavbarLogo(true);
    }, 3500); // Show navbar logo after hero logo animation starts moving
        ...
        <div className="flex items-center justify-between h-32">
          ...
          <div
            ...
            style={{
              ...
              transform: showNavbarLogo ? 'translateY(0)' : 'translateY(-20px)'
            }}
          >
